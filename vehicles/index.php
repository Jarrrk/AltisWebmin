...
<html>
	<head>
		<title>Altis Life Panel: Vehicles</title>
      				...
      				<div class="navbar-header">
      			  	...
      			  	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-7">
      			    	<ul class="nav navbar-nav">
      			      		...
      			      		<?php
      			      		if($sessionType){
      			      			echo "<li><a href='../players/'><img class='nav-icon' src='../assets/img/002.png'/>Players</a></li><li class='active'><a href='#''><img class='nav-icon' src='../assets/img/003.png'/>Vehicles</a></li>";
      			      			if($adminRank == 1){
		...
		<div class="content-main">
			<div class="admin-panel fadeDown"> 
				<div class="panel-title">
					<h1><u>Vehicles</u></h1>
					<p>Sort and manage players' Vehicles</p>
				</div>
    				  	...
    				  	<table class="table">
    				  	  	...
    				  	  	<tbody>
    				  	    	<tr>
    				  	      		<td>1</td>
    				  	      		<td>Jarrrk</td>
    				  	      		<td>12323434545656786</td>
    				  	      		<td contenteditable="true">$25,439</td>
    				  	      		<td contenteditable="true">{'drivers':1}</td>
    				  	    	...
    				  	    	<tr>
    				  	      		<td>2</td>
    				  	      		<td>JK8C19</td>
    				  	      		<td>67485739485738495</td>
    				  	      		<td contenteditable="true">$95,349</td>
    				  	      		<td contenteditable="true">{'drivers':1}</td>
    				  	      		<td contenteditable="true">0</td>
    				  	      		<td>{'Jake'}</td>
    				  	    	...
    				  	    	<tr>
    				  	    	  	<td>3</td>
    				  	      		<td>Fieldmau5</td>
    				  	      		<td>39584938475839482</td>
    				  	      		<td contenteditable="true">$1,000</td>
    				  	      		<td contenteditable="true">{'drivers':0}</td>
